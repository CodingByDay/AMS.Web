...
exports.defaultLocalization = {
    ...
    'DashboardStringId.CommandFormatRuleRangeSetRanges2': 'Ranges 2',
    'DashboardStringId.CommandFormatRuleRangeSetRanges3': 'Ranges 3',
    'DashboardStringId.CommandFormatRuleRangeSetRanges4': 'Ranges 4',
    'DashboardStringId.CommandFormatRuleRangeSetRanges5': 'Ranges 5',
    'DashboardStringId.CommandFormatRuleRangeSet2ColorGradientRanges': '2 Color Gradient Ranges',
    'DashboardStringId.CommandFormatRuleRangeSet3ColorGradientRanges': '3 Color Gradient Ranges',
    'DashboardStringId.CommandFormatRuleValue': 'Value',
    'DashboardStringId.CommandFormatRuleDateOccurring': 'A Date Occurring',
    'DashboardWebStringId.ConditionalFormatting.Appearance.BackColor': 'Background color',
    'DashboardWebStringId.ConditionalFormatting.Appearance.ForeColor': 'Text color',
    ...
    'DashboardWebStringId.DataSources.AvailableDataSourcesError': 'An error occurred during an attempt to load the list of available data sources',
    ...
    'DashboardWebStringId.Chart.Indicator.DashStyle': 'Dash Style',
    'DashboardWebStringId.Chart.Indicator.DashStyle.Empty': 'Empty',
    'DashboardWebStringId.Chart.Indicator.DashStyle.Solid': 'Solid',
    'DashboardWebStringId.Chart.Indicator.DashStyle.Dash': 'Dash',
    'DashboardWebStringId.Chart.Indicator.DashStyle.Dot': 'Dot',
    'DashboardWebStringId.Chart.Indicator.DashStyle.DashDot': 'DashDot',
    'DashboardWebStringId.Chart.Indicator.DashStyle.DashDotDot': 'DashDotDot',
    'DashboardWebStringId.Chart.Indicator.Type': 'Type',
    'DashboardWebStringId.Chart.Indicator.Type.Regression': 'Regression',
    'DashboardWebStringId.Chart.Indicator.Type.Trend': 'Trend',
    'DashboardWebStringId.Chart.Indicator.LegendText': 'Legend Text',
    'DashboardWebStringId.Chart.Indicator.ShowInLegend': 'Display in legend',
    'DashboardWebStringId.Chart.Indicator.Thickness': 'Thickness',
    'DashboardWebStringId.Chart.Indicator.ValueLevel': 'Value level',
    'DashboardWebStringId.Chart.Indicator.ValueLevel.Value': 'Value',
    'DashboardWebStringId.Chart.Indicator.Visible': 'Visible',
    'DashboardWebStringId.Chart.Indicator.Color': 'Color',
    'DashboardWebStringId.Chart.Indicator.Value': 'Value',
    'DashboardWebStringId.Chart.Indicators': 'Trend Indicators',
    'DashboardWebStringId.Chart.IndicatorSettings': 'Indicator settings',
    ...
    'DashboardWebStringId.FormatConditionPredefinedAppearanceCaption': 'Predefined Appearance',
    'DashboardWebStringId.FormatConditionCustomAppearanceCaption': 'Custom Appearance',
    'DashboardWebStringId.FormatConditionRangeSetNoStyleCaption': 'No Style',
    'DashboardWebStringId.EditorAutomaticValue': '(Automatic)',
    'DashboardWebStringId.ConditionalFormatting.Save': 'Save',
    ...
    'DashboardWebStringId.ConditionalFormatting.CustomStyleSettings': 'Custom Style Settings',
    ...
    'DashboardWebStringId.Errors.AttemptToLoadData': 'An error occurred during an attempt to load data',
    ...
    'DashboardWebStringId.Notification.AttemptToLoadDashboards': 'An error occurred during an attempt to load the list of available dashboards',
    'DashboardWebStringId.Notification.DashboardLoading': 'Dashboard is loading...',
    'DashboardWebStringId.Notification.AttemptToLoadDashboard': 'An error occurred during an attempt to load the dashboard ',
    'DashboardWebStringId.Notification.AttemptToConnectionStrings': 'An error occurred during an attempt to load connection strings',
    'DashboardWebStringId.Notification.MethodIsNotAllowedInViewerMode': 'This method is not allowed in the viewer mode',
    'DashboardWebStringId.Notification.AttemptToLoadParameterValues': 'An error occurred during an attempt to load parameter values for the data source ',
    'DashboardWebStringId.Notification.AttemptToGetUnderlyingData': 'An error occurred during an attempt to get underlying data for the item ',
    'DashboardWebStringId.Notification.AttemptToConvertItemToType': 'An error occurred during an attempt to convert the item to the type ',
    'DashboardWebStringId.Notification.AttemptToLoadDimensionUniqueValues': 'An error occurred during an attempt to load dimension unique values for the data source ',
    'DashboardWebStringId.Notification.AttemptToLoadFieldListForDataSource': 'An error occurred during an attempt to load the field list for the data source ',
    'DashboardWebStringId.Notification.AttemptToGetColorScheme': 'An error occurred during an attempt to get the color scheme',
    'DashboardWebStringId.Notification.AttemptToLoadAvailableFontFamilies': 'An error occurred during an attempt to load available font families',
    'DashboardWebStringId.Notification.AttemptToPerformExport': 'An error occurred during an attempt to perform export',
    'DashboardWebStringId.Notification.NewDashboardCannotBeCreated': 'A new dashboard cannot be created',
    'DashboardWebStringId.Notification.ErrorHasOccuredOn': 'An error occurred during an',
    ...
    'DashboardWebStringId.SearchFontFamilies': 'Search font families...',
    'DashboardStringId.DefaultNameTabPage': 'Page',
    'DashboardStringId.DefaultNameChartPane': 'Pane',
    'DashboardStringId.DefaultNameChartIndicator': 'indicator',
    ...
    'DashboardStringId.NumberRangeValidationMessage': 'Value is out of ranges',
