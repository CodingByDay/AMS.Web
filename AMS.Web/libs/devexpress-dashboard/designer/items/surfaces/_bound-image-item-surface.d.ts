...
export declare class BoundImageItemSurface extends DataDashboardItemSurface<BoundImageItem> {
    fillSections(): void;
    constructor(dashboardItem: BoundImageItem, dashboardModel: Dashboard, dataSourceBrowser: DataSourceBrowser, notificationController: NotificationController);
