...
export declare class PieItemSurface extends DataDashboardItemSurface<PieItem> {
    fillSections(): void;
    constructor(dashboardItem: PieItem, dashboardModel: Dashboard, dataSourceBrowser: DataSourceBrowser, notificationController: NotificationController);
