/**
* DevExpress Dashboard (custom-item-calc-window-definition.d.ts)
* Version:  23.1.4
...
export declare class CustomItemWindowDefinition extends MeasureCalculationWindowDefinition {
