...
import { ForceSyncWithServerCallbackManager, ForceSyncWithServerCommand } from './control/force-sync-with-server-command';
import { InsertContentFromServerCommand, InsertContentFromServerRequestManager } from './control/insert-content-from-server-command';
...
import { DialogOpenFileCommand } from './dialogs/dialog-open-file-command';
...
import { DialogSaveFileCommand, DialogSaveMergedDocumentCommand } from './dialogs/dialog-save-file-command';
...
import { DownloadDocumentCommand } from './document/download-document-command';
import { NewDocumentCommand } from './document/new-document-command';
import { PrintDocumentCommand } from './document/print-document-command';
import { PrintDocumentOnClient } from './document/print-document-on-client-command';
import { ReloadDocumentCommand } from './document/reload-document-command';
import { SaveDocumentCommand } from './document/save-document-command';
...
import { GetRtfCommand } from './rtf/get-rtf-command';
import { InsertRtfCommand } from './rtf/insert-rtf-command';
...
export class CommandManager {
    constructor(control, printNonce) {
        ...
        this.forceSyncWithServerCallbackManager = new ForceSyncWithServerCallbackManager();
        this.insertContentFromServerRequestManager = new InsertContentFromServerRequestManager();
        ...
        this.createCommand(control, RichEditClientCommand.FileNew, NewDocumentCommand);
        this.createCommand(control, RichEditClientCommand.FileOpen, DialogOpenFileCommand);
        this.createCommand(control, RichEditClientCommand.FilePrint, PrintDocumentCommand);
        this.createCommand(control, RichEditClientCommand.FileSave, SaveDocumentCommand);
        this.createCommand(control, RichEditClientCommand.FileSaveAs, DialogSaveFileCommand);
        this.createCommand(control, RichEditClientCommand.FullScreen, ToggleFullScreenCommand);
        this.createCommand(control, RichEditClientCommand.ForceSyncWithServer, ForceSyncWithServerCommand);
        ...
        this.createCommand(control, RichEditClientCommand.ReloadDocument, ReloadDocumentCommand);
        ...
        this.createCommand(control, RichEditClientCommand.ShowSaveMergedDocumentForm, DialogSaveMergedDocumentCommand);
        ...
        this.createCommand(control, RichEditClientCommand.Download, DownloadDocumentCommand);
        ...
        this.createCommand(control, RichEditClientCommand.InsertRtf, InsertRtfCommand);
        this.createCommand(control, RichEditClientCommand.GetRtf, GetRtfCommand);
        this.createCommand(control, RichEditClientCommand.InsertContentFromServer, InsertContentFromServerCommand);
