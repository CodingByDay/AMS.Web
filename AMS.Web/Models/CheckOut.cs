namespace AMS.Web.Models
{
    public class CheckOut
    {
        ...
        public int anInventory { get; set; }

        public int anAssetID { get; set; }
        ...
        public String adDateCheck { get; set; }

        public int anUserCheck { get; set; }

        public String adStringConfirm { get; set; }

        public int anUserConfirm { get; set; }
